...
class User_Ride(models.Model):
    ...
    initial_lat = models.CharField(max_length = 20, blank = True)
    initial_long = models.CharField(max_length = 20, blank = True)
    final_pos = models.CharField(max_length = 50, blank = True)
    final_lat = models.CharField(max_length = 20, blank = True)
    final_long = models.CharField(max_length = 20, blank = True)
